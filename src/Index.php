      ...
      ?> 
        ...
        <div class="aportaciones">
          ...
          <div class="iconos">
            ...
            <a href="<?php echo $row["correo"];?>">  <i class="fab fa-linkedin-in"></i></a> <!-- cambir al nombre del campo de latbla, quitar correo y poner linkedin -->

            <a href="<?php echo $row["redes"];?>"> <i class="fa-brands fa-github"></i></a><!-- cambir al nombre del campo de latbla, quitar redes y poner github -->
          </div>
